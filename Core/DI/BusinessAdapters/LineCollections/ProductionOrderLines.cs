//-----------------------------------------------------------------------
// <copyright file="ProductionOrderLines.cs" company="B1C Canada Inc.">
...
namespace B1C.SAP.DI.BusinessAdapters
{
    ...
    public class ProductionOrderLines : SapBaseObject, IEnumerable, IEnumerator
    {
        #region Fields
        /// <summary>
        /// The SAP document lines
        /// </summary>
        private ProductionOrders_Lines lines;
        ...
        public ProductionOrderLines(ProductionOrders_Lines lines)
        {
            this.lines = lines;
        }
        ...
        /// <returns>The current element in the collection.</returns>
        /// <exception cref="T:System.InvalidOperationException">The enumerator is positioned before the first element of the collection or after the last element.-or- The collection was modified after the enumerator was created.</exception>
        public ProductionOrders_Lines Current
        {
            get
            {
                this.lines.SetCurrentLine(this.currentLine);
        ...
        public ProductionOrders_Lines Add(int lineNum)
        {
