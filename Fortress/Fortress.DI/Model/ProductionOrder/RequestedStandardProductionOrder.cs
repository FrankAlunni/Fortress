...
namespace Fortress.DI.Model.ProductionOrder
{
    ...
    public class RequestedStandardProductionOrder : RequestedProductionOrder
    {
        /// <summary>
        ...
        public RequestedStandardProductionOrder(int salesOrderId, int salesOrderLine, string itemCode, int drawingVersion)
